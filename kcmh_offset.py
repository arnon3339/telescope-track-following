...
DATA_DIR = "./data/experiment/data-col/run56170512_240203170517"
...
if __name__ == "__main__":
    ...
    # data = utils.gen_roots2csv(data_path, name="run56170512_240203170517")
    # data = pd.read_csv("./", index_col=None)
